...
#ifndef UMPCORE_SWIFT_H
#define UMPCORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="UMPCore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC7UMPCore12BaseAdClient")
@interface BaseAdClient : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC7UMPCore16BaseBannerClient")
@interface BaseBannerClient : BaseAdClient
@end


SWIFT_CLASS("_TtC7UMPCore20BaseFullscreenClient")
@interface BaseFullscreenClient : BaseAdClient
@end

@class NSString;

SWIFT_CLASS("_TtC7UMPCore8OCBridge")
@interface OCBridge : NSObject
+ (void)initializePluginWithTestMode:(BOOL)testMode callback:(InitializeCallback _Nonnull)callback;
+ (void)initializePlatformWithPlatform:(NSInteger)platform className:(NSString * _Nonnull)className appKey:(NSString * _Nullable)appKey callback:(InitializeCallback _Nonnull)callback;
+ (NSInteger)createClientWithPlatform:(NSInteger)platform adFormat:(NSInteger)adFormat callback:(struct UnionedAdCallbacks)callback SWIFT_WARN_UNUSED_RESULT;
...
#undef SWIFT_SYMBOL
#endif
#define SWIFT_SYMBOL(usrValue) SWIFT_SYMBOL_MODULE_USR("UMPCore", usrValue)
#ifndef SWIFT_PRINTED_CORE
#define SWIFT_PRINTED_CORE
namespace swift SWIFT_PRIVATE_ATTR {
...
#endif
#ifdef __cplusplus
namespace UMPCore SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("UMPCore") {
namespace _impl {
extern "C" {
#endif

// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_returnStub_UMPCore_uint64_t_0_8_void_ptr_8_16 {
  uint64_t _1;
  void * _Nullable _2;
};

static SWIFT_C_INLINE_THUNK void swift_interop_returnDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(char * _Nonnull result, struct swift_interop_returnStub_UMPCore_uint64_t_0_8_void_ptr_8_16 value) {
  memcpy(result + 0, &value._1, 8);
  memcpy(result + 8, &value._2, 8);
}

SWIFT_EXTERN struct swift_interop_returnStub_UMPCore_uint64_t_0_8_void_ptr_8_16 $s7UMPCore8AdFormatO4nameSSyF(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // name()
SWIFT_EXTERN void $s7UMPCore8AdFormatO8rawValueACSgSi_tcfC(SWIFT_INDIRECT_RESULT void * _Nonnull, ptrdiff_t rawValue) SWIFT_NOEXCEPT SWIFT_CALL; // init(rawValue:)
SWIFT_EXTERN ptrdiff_t $s7UMPCore8AdFormatO8rawValueSivg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s7UMPCore10AdPositionO8rawValueACSgSi_tcfC(SWIFT_INDIRECT_RESULT void * _Nonnull, ptrdiff_t rawValue) SWIFT_NOEXCEPT SWIFT_CALL; // init(rawValue:)
SWIFT_EXTERN ptrdiff_t $s7UMPCore10AdPositionO8rawValueSivg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN ptrdiff_t $s7UMPCore7AdValueV5valueSivg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN struct swift_interop_returnStub_UMPCore_uint64_t_0_8_void_ptr_8_16 $s7UMPCore7AdValueV12currencyCodeSSvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_passStub_UMPCore_uint64_t_0_8_uint64_t_8_16 {
  uint64_t _1;
  uint64_t _2;
};

static SWIFT_C_INLINE_THUNK struct swift_interop_passStub_UMPCore_uint64_t_0_8_uint64_t_8_16 swift_interop_passDirect_UMPCore_uint64_t_0_8_uint64_t_8_16(const char * _Nonnull value) {
  struct swift_interop_passStub_UMPCore_uint64_t_0_8_uint64_t_8_16 result;
  memcpy(&result._1, value + 0, 8);
  memcpy(&result._2, value + 8, 8);
  return result;
}

SWIFT_EXTERN void $s7UMPCore7AdValueV5value12currencyCodeACSi_SSSgtcfC(SWIFT_INDIRECT_RESULT void * _Nonnull, ptrdiff_t value, struct swift_interop_passStub_UMPCore_uint64_t_0_8_uint64_t_8_16 currencyCode) SWIFT_NOEXCEPT SWIFT_CALL; // init(value:currencyCode:)
// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 {
  uint64_t _1;
  void * _Nullable _2;
};

static SWIFT_C_INLINE_THUNK struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(const char * _Nonnull value) {
  struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 result;
  memcpy(&result._1, value + 0, 8);
  memcpy(&result._2, value + 8, 8);
  return result;
}

SWIFT_EXTERN void $s7UMPCore9CppBridgeC23setPluginExtraParameter7groupId3key5valueySS_SSSPys4Int8VGSgtFZ(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 groupId, struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 key, int8_t const * _Nullable value, SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // setPluginExtraParameter(groupId:key:value:)
SWIFT_EXTERN int8_t * _Nullable $s7UMPCore9CppBridgeC23getPluginExtraParameter7groupId3keySpys4Int8VGSgSS_SStFZ(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 groupId, struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 key, SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // getPluginExtraParameter(groupId:key:)
SWIFT_EXTERN void $s7UMPCore9CppBridgeC17setExtraParameter6handle6unitId3key5valueySi_S3StFZ(ptrdiff_t handle, struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 key, struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 value, SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // setExtraParameter(handle:unitId:key:value:)
SWIFT_EXTERN void $s7UMPCore9CppBridgeC4load6handle6unitIdySi_SStFZ(ptrdiff_t handle, struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // load(handle:unitId:)
SWIFT_EXTERN bool $s7UMPCore9CppBridgeC7isReady6handle6unitIdSbSi_SStFZ(ptrdiff_t handle, struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // isReady(handle:unitId:)
SWIFT_EXTERN void $s7UMPCore9CppBridgeC4show6handle6unitIdySi_SStFZ(ptrdiff_t handle, struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // show(handle:unitId:)
SWIFT_EXTERN void $s7UMPCore9CppBridgeC7destroy6handle6unitIdySi_SStFZ(ptrdiff_t handle, struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // destroy(handle:unitId:)
SWIFT_EXTERN void $s7UMPCore9CppBridgeC4load6handle6unitId5width6height8positionySi_SSS3itFZ(ptrdiff_t handle, struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, ptrdiff_t width, ptrdiff_t height, ptrdiff_t position, SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // load(handle:unitId:width:height:position:)
SWIFT_EXTERN void $s7UMPCore9CppBridgeC4hide6handle6unitIdySi_SStFZ(ptrdiff_t handle, struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // hide(handle:unitId:)
SWIFT_EXTERN int8_t * _Nullable $s7UMPCore9CppBridgeC14getCharPointer4fromSpys4Int8VGSgSSSg_tFZ(struct swift_interop_passStub_UMPCore_uint64_t_0_8_uint64_t_8_16 optionalString, SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // getCharPointer(from:)
SWIFT_EXTERN ptrdiff_t $s7UMPCore11ErrorClientV4codeSivg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN struct swift_interop_returnStub_UMPCore_uint64_t_0_8_void_ptr_8_16 $s7UMPCore11ErrorClientV7messageSSvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s7UMPCore11ErrorClientV4code7messageACSi_SStcfC(SWIFT_INDIRECT_RESULT void * _Nonnull, ptrdiff_t code, struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 message) SWIFT_NOEXCEPT SWIFT_CALL; // init(code:message:)
SWIFT_EXTERN void $s7UMPCore6LoggerC1d7messageySS_tFZ(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 message, SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // d(message:)
SWIFT_EXTERN void * _Nonnull $s7UMPCore11MediationAdCACycfC(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // init()
SWIFT_EXTERN struct swift_interop_returnStub_UMPCore_uint64_t_0_8_void_ptr_8_16 $s7UMPCore11MediationAdC6toJsonSSyF(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // toJson()
SWIFT_EXTERN struct swift_interop_returnStub_UMPCore_uint64_t_0_8_void_ptr_8_16 $s7UMPCore11MediationAdC6toJsonSSyFTj(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // dispatch thunk for toJson()
SWIFT_EXTERN ptrdiff_t $s7UMPCore8PlatformV2idSivg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN struct swift_interop_returnStub_UMPCore_uint64_t_0_8_void_ptr_8_16 $s7UMPCore8PlatformV4nameSSvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s7UMPCore8PlatformV4nameSSvs(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s7UMPCore8PlatformV2id4nameACSi_SStcfC(SWIFT_INDIRECT_RESULT void * _Nonnull, ptrdiff_t id, struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 name) SWIFT_NOEXCEPT SWIFT_CALL; // init(id:name:)
SWIFT_EXTERN void $s7UMPCore13PluginManagerC17setExtraParameter7groupId3key5valueySS_S2SSgtFZ(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 groupId, struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 key, struct swift_interop_passStub_UMPCore_uint64_t_0_8_uint64_t_8_16 value, SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // setExtraParameter(groupId:key:value:)
// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_returnStub_UMPCore_uint64_t_0_8_uint64_t_8_16 {
  uint64_t _1;
  uint64_t _2;
};

static SWIFT_C_INLINE_THUNK void swift_interop_returnDirect_UMPCore_uint64_t_0_8_uint64_t_8_16(char * _Nonnull result, struct swift_interop_returnStub_UMPCore_uint64_t_0_8_uint64_t_8_16 value) {
  memcpy(result + 0, &value._1, 8);
  memcpy(result + 8, &value._2, 8);
}

SWIFT_EXTERN struct swift_interop_returnStub_UMPCore_uint64_t_0_8_uint64_t_8_16 $s7UMPCore13PluginManagerC17getExtraParameter7groupId3keySSSgSS_SStFZ(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 groupId, struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 key, SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // getExtraParameter(groupId:key:)
SWIFT_EXTERN double $s7UMPCore9RevenueAdC7revenueSdvg(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void * _Nonnull $s7UMPCore9RevenueAdC7revenueACSd_tcfC(double revenue, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // init(revenue:)
SWIFT_EXTERN void * _Nonnull $s7UMPCore9RevenueAdCACycfC(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // init()
SWIFT_EXTERN double $s7UMPCore6RewardV5mountSdvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN struct swift_interop_returnStub_UMPCore_uint64_t_0_8_uint64_t_8_16 $s7UMPCore6RewardV4typeSSSgvg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s7UMPCore6RewardV5mount4typeACSd_SSSgtcfC(SWIFT_INDIRECT_RESULT void * _Nonnull, double mount, struct swift_interop_passStub_UMPCore_uint64_t_0_8_uint64_t_8_16 type) SWIFT_NOEXCEPT SWIFT_CALL; // init(mount:type:)
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC8adFormatAA02AdE0Ovg(SWIFT_INDIRECT_RESULT void * _Nonnull, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC8platformAA8PlatformVvg(SWIFT_INDIRECT_RESULT void * _Nonnull, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC17setExtraParameter6unitId3key5valueySS_S2SSgtF(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 key, struct swift_interop_passStub_UMPCore_uint64_t_0_8_uint64_t_8_16 value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // setExtraParameter(unitId:key:value:)
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC17setExtraParameter6unitId3key5valueySS_S2SSgtFTj(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 key, struct swift_interop_passStub_UMPCore_uint64_t_0_8_uint64_t_8_16 value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // dispatch thunk for setExtraParameter(unitId:key:value:)
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC4load6unitId5width6height8positionySS_S3itF(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, ptrdiff_t width, ptrdiff_t height, ptrdiff_t position, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // load(unitId:width:height:position:)
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC4load6unitId5width6height8positionySS_S3itFTj(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, ptrdiff_t width, ptrdiff_t height, ptrdiff_t position, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // dispatch thunk for load(unitId:width:height:position:)
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC4load6unitIdySS_tF(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // load(unitId:)
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC4load6unitIdySS_tFTj(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // dispatch thunk for load(unitId:)
SWIFT_EXTERN bool $s7UMPCore12UnityHandlerC7isReady6unitIdSbSS_tF(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // isReady(unitId:)
SWIFT_EXTERN bool $s7UMPCore12UnityHandlerC7isReady6unitIdSbSS_tFTj(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // dispatch thunk for isReady(unitId:)
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC4show6unitIdySS_tF(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // show(unitId:)
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC4show6unitIdySS_tFTj(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // dispatch thunk for show(unitId:)
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC4hide6unitIdySS_tF(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // hide(unitId:)
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC4hide6unitIdySS_tFTj(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // dispatch thunk for hide(unitId:)
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC7destroy6unitIdySS_tF(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // destroy(unitId:)
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC7destroy6unitIdySS_tFTj(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // dispatch thunk for destroy(unitId:)
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC16onAdFailedToLoad6unitId11errorClientySS_AA05ErrorL0VtF(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, const void * _Nonnull errorClient, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // onAdFailedToLoad(unitId:errorClient:)
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC16onAdFailedToLoad6unitId11errorClientySS_AA05ErrorL0VtFTj(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, const void * _Nonnull errorClient, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // dispatch thunk for onAdFailedToLoad(unitId:errorClient:)
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC16onAdFailedToShow6unitId11errorClientySS_AA05ErrorL0VtF(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, const void * _Nonnull errorClient, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // onAdFailedToShow(unitId:errorClient:)
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC16onAdFailedToShow6unitId11errorClientySS_AA05ErrorL0VtFTj(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, const void * _Nonnull errorClient, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // dispatch thunk for onAdFailedToShow(unitId:errorClient:)
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC14onAdImpression6unitIdySS_tF(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // onAdImpression(unitId:)
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC14onAdImpression6unitIdySS_tFTj(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // dispatch thunk for onAdImpression(unitId:)
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC11onAdClicked6unitIdySS_tF(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // onAdClicked(unitId:)
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC11onAdClicked6unitIdySS_tFTj(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // dispatch thunk for onAdClicked(unitId:)
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC10onAdClosed6unitIdySS_tF(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // onAdClosed(unitId:)
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC10onAdClosed6unitIdySS_tFTj(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // dispatch thunk for onAdClosed(unitId:)
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC18onUserEarnedReward6unitId6rewardySS_AA0G0VtF(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, const void * _Nonnull reward, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // onUserEarnedReward(unitId:reward:)
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC18onUserEarnedReward6unitId6rewardySS_AA0G0VtFTj(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, const void * _Nonnull reward, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // dispatch thunk for onUserEarnedReward(unitId:reward:)
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC20onBannerDetailOpened6unitIdySS_tF(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // onBannerDetailOpened(unitId:)
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC20onBannerDetailOpened6unitIdySS_tFTj(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // dispatch thunk for onBannerDetailOpened(unitId:)
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC20onBannerDetailClosed6unitIdySS_tF(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // onBannerDetailClosed(unitId:)
SWIFT_EXTERN void $s7UMPCore12UnityHandlerC20onBannerDetailClosed6unitIdySS_tFTj(struct swift_interop_passStub_UMPCore_uint64_t_0_8_void_ptr_8_16 unitId, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // dispatch thunk for onBannerDetailClosed(unitId:)
...
class SWIFT_SYMBOL("s:7UMPCore8AdFormatO") AdFormat;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<UMPCore::AdFormat> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_AdFormat;

// Type metadata accessor for AdFormat
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s7UMPCore8AdFormatOMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;

// Tags for resilient enum AdFormat
extern "C" {
extern unsigned $s7UMPCore8AdFormatO6banneryA2CmFWC;
extern unsigned $s7UMPCore8AdFormatO12interstitialyA2CmFWC;
extern unsigned $s7UMPCore8AdFormatO6rewardyA2CmFWC;
}

} // namespace _impl

class SWIFT_SYMBOL("s:7UMPCore8AdFormatO") AdFormat final {
public:
  SWIFT_INLINE_THUNK ~AdFormat() noexcept {
    auto metadata = _impl::$s7UMPCore8AdFormatOMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
#else
  ...
  SWIFT_INLINE_THUNK AdFormat(const AdFormat &other) noexcept {
    auto metadata = _impl::$s7UMPCore8AdFormatOMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK AdFormat &operator =(const AdFormat &other) noexcept {
    auto metadata = _impl::$s7UMPCore8AdFormatOMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK AdFormat &operator =(AdFormat &&other) = delete;
  [[noreturn]] SWIFT_INLINE_PRIVATE_HELPER AdFormat(AdFormat &&) noexcept {
  swift::_impl::_fatalError_Cxx_move_of_Swift_value_type_not_supported_yet();
  swift::_impl::_swift_stdlib_reportFatalError("swift", 5, "C++ does not support moving a Swift value yet", 45, 0);
  abort();
  }
  ...
  enum class cases {
    banner SWIFT_SYMBOL("s:7UMPCore8AdFormatO6banneryA2CmF"),
    interstitial SWIFT_SYMBOL("s:7UMPCore8AdFormatO12interstitialyA2CmF"),
    reward SWIFT_SYMBOL("s:7UMPCore8AdFormatO6rewardyA2CmF"),
    unknownDefault
  };

#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"  // allow use of inline static data member
  inline const static struct _impl_banner {  // impl struct for case banner
    SWIFT_INLINE_THUNK constexpr operator cases() const {
      return cases::banner;
    }
    SWIFT_INLINE_THUNK AdFormat operator()() const;
  } banner SWIFT_SYMBOL("s:7UMPCore8AdFormatO6banneryA2CmF");
  SWIFT_INLINE_THUNK bool isBanner() const;

  inline const static struct _impl_interstitial {  // impl struct for case interstitial
    SWIFT_INLINE_THUNK constexpr operator cases() const {
      return cases::interstitial;
    }
    SWIFT_INLINE_THUNK AdFormat operator()() const;
  } interstitial SWIFT_SYMBOL("s:7UMPCore8AdFormatO12interstitialyA2CmF");
  SWIFT_INLINE_THUNK bool isInterstitial() const;

  inline const static struct _impl_reward {  // impl struct for case reward
    SWIFT_INLINE_THUNK constexpr operator cases() const {
      return cases::reward;
    }
    SWIFT_INLINE_THUNK AdFormat operator()() const;
  } reward SWIFT_SYMBOL("s:7UMPCore8AdFormatO6rewardyA2CmF");
  SWIFT_INLINE_THUNK bool isReward() const;
...
#pragma clang diagnostic pop
  SWIFT_INLINE_THUNK operator cases() const {
    ...
    if (tag == _impl::$s7UMPCore8AdFormatO6banneryA2CmFWC) return cases::banner;
    if (tag == _impl::$s7UMPCore8AdFormatO12interstitialyA2CmFWC) return cases::interstitial;
    if (tag == _impl::$s7UMPCore8AdFormatO6rewardyA2CmFWC) return cases::reward;
    return cases::unknownDefault;
  }

  SWIFT_INLINE_THUNK swift::String name() const SWIFT_SYMBOL("s:7UMPCore8AdFormatO4nameSSyF");
  static SWIFT_INLINE_THUNK swift::Optional<AdFormat> init(swift::Int rawValue) SWIFT_SYMBOL("s:7UMPCore8AdFormatO8rawValueACSgSi_tcfc");
  SWIFT_INLINE_THUNK swift::Int getRawValue() const SWIFT_SYMBOL("s:7UMPCore8AdFormatO8rawValueSivp");
private:
  SWIFT_INLINE_THUNK AdFormat(swift::_impl::ValueWitnessTable * _Nonnull vwTable) noexcept : _storage(vwTable->size, vwTable->getAlignment()) {}
  static SWIFT_INLINE_THUNK AdFormat _make() noexcept {
    auto metadata = _impl::$s7UMPCore8AdFormatOMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  swift::_impl::OpaqueStorage _storage;
  friend class _impl::_impl_AdFormat;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s7UMPCore8AdFormatOD;
  static inline constexpr $s7UMPCore8AdFormatOD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_AdFormat {
public:
  static SWIFT_INLINE_THUNK char * _Nonnull getOpaquePointer(AdFormat &object) { return object._getOpaquePointer(); }
  static SWIFT_INLINE_THUNK const char * _Nonnull getOpaquePointer(const AdFormat &object) { return object._getOpaquePointer(); }
  template<class T>
  static SWIFT_INLINE_PRIVATE_HELPER AdFormat returnNewValue(T callable) {
    auto result = AdFormat::_make();
    callable(result._getOpaquePointer());
    return result;
  }
  static SWIFT_INLINE_THUNK void initializeWithTake(char * _Nonnull destStorage, char * _Nonnull srcStorage) {
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<UMPCore::AdFormat> {
  static SWIFT_INLINE_THUNK void * _Nonnull getTypeMetadata() {
    return UMPCore::_impl::$s7UMPCore8AdFormatOMa(0)._0;
  }
};
namespace _impl{
template<>
static inline const constexpr bool isValueType<UMPCore::AdFormat> = true;
template<>
static inline const constexpr bool isOpaqueLayout<UMPCore::AdFormat> = true;
template<>
struct implClassFor<UMPCore::AdFormat> { using type = UMPCore::_impl::_impl_AdFormat; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class SWIFT_SYMBOL("s:7UMPCore10AdPositionO") AdPosition;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<UMPCore::AdPosition> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_AdPosition;

// Type metadata accessor for AdPosition
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s7UMPCore10AdPositionOMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;

// Tags for resilient enum AdPosition
extern "C" {
extern unsigned $s7UMPCore10AdPositionO3topyA2CmFWC;
extern unsigned $s7UMPCore10AdPositionO6centeryA2CmFWC;
extern unsigned $s7UMPCore10AdPositionO6bottomyA2CmFWC;
}

} // namespace _impl

class SWIFT_SYMBOL("s:7UMPCore10AdPositionO") AdPosition final {
public:
  SWIFT_INLINE_THUNK ~AdPosition() noexcept {
    auto metadata = _impl::$s7UMPCore10AdPositionOMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
#else
  ...
  SWIFT_INLINE_THUNK AdPosition(const AdPosition &other) noexcept {
    auto metadata = _impl::$s7UMPCore10AdPositionOMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK AdPosition &operator =(const AdPosition &other) noexcept {
    auto metadata = _impl::$s7UMPCore10AdPositionOMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK AdPosition &operator =(AdPosition &&other) = delete;
  [[noreturn]] SWIFT_INLINE_PRIVATE_HELPER AdPosition(AdPosition &&) noexcept {
  swift::_impl::_fatalError_Cxx_move_of_Swift_value_type_not_supported_yet();
  swift::_impl::_swift_stdlib_reportFatalError("swift", 5, "C++ does not support moving a Swift value yet", 45, 0);
  abort();
  }
  ...
  enum class cases {
    top SWIFT_SYMBOL("s:7UMPCore10AdPositionO3topyA2CmF"),
    center SWIFT_SYMBOL("s:7UMPCore10AdPositionO6centeryA2CmF"),
    bottom SWIFT_SYMBOL("s:7UMPCore10AdPositionO6bottomyA2CmF"),
    unknownDefault
  };
...
#pragma clang diagnostic ignored "-Wc++17-extensions"  // allow use of inline static data member
  inline const static struct _impl_top {  // impl struct for case top
    ...
    SWIFT_INLINE_THUNK AdPosition operator()() const;
  } top SWIFT_SYMBOL("s:7UMPCore10AdPositionO3topyA2CmF");
  ...
  inline const static struct _impl_bottom {  // impl struct for case bottom
    SWIFT_INLINE_THUNK constexpr operator cases() const {
      return cases::bottom;
    }
    SWIFT_INLINE_THUNK AdPosition operator()() const;
  } bottom SWIFT_SYMBOL("s:7UMPCore10AdPositionO6bottomyA2CmF");
  SWIFT_INLINE_THUNK bool isBottom() const;
...
#pragma clang diagnostic pop
  SWIFT_INLINE_THUNK operator cases() const {
    auto tag = _getEnumTag();
    if (tag == _impl::$s7UMPCore10AdPositionO3topyA2CmFWC) return cases::top;
    if (tag == _impl::$s7UMPCore10AdPositionO6centeryA2CmFWC) return cases::center;
    if (tag == _impl::$s7UMPCore10AdPositionO6bottomyA2CmFWC) return cases::bottom;
    return cases::unknownDefault;
  }

  static SWIFT_INLINE_THUNK swift::Optional<AdPosition> init(swift::Int rawValue) SWIFT_SYMBOL("s:7UMPCore10AdPositionO8rawValueACSgSi_tcfc");
  SWIFT_INLINE_THUNK swift::Int getRawValue() const SWIFT_SYMBOL("s:7UMPCore10AdPositionO8rawValueSivp");
private:
  SWIFT_INLINE_THUNK AdPosition(swift::_impl::ValueWitnessTable * _Nonnull vwTable) noexcept : _storage(vwTable->size, vwTable->getAlignment()) {}
  static SWIFT_INLINE_THUNK AdPosition _make() noexcept {
    auto metadata = _impl::$s7UMPCore10AdPositionOMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  swift::_impl::OpaqueStorage _storage;
  friend class _impl::_impl_AdPosition;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s7UMPCore10AdPositionOD;
  static inline constexpr $s7UMPCore10AdPositionOD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_AdPosition {
public:
  static SWIFT_INLINE_THUNK char * _Nonnull getOpaquePointer(AdPosition &object) { return object._getOpaquePointer(); }
  static SWIFT_INLINE_THUNK const char * _Nonnull getOpaquePointer(const AdPosition &object) { return object._getOpaquePointer(); }
  template<class T>
  static SWIFT_INLINE_PRIVATE_HELPER AdPosition returnNewValue(T callable) {
    auto result = AdPosition::_make();
    callable(result._getOpaquePointer());
    return result;
  }
  static SWIFT_INLINE_THUNK void initializeWithTake(char * _Nonnull destStorage, char * _Nonnull srcStorage) {
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<UMPCore::AdPosition> {
  static SWIFT_INLINE_THUNK void * _Nonnull getTypeMetadata() {
    return UMPCore::_impl::$s7UMPCore10AdPositionOMa(0)._0;
  }
};
namespace _impl{
template<>
static inline const constexpr bool isValueType<UMPCore::AdPosition> = true;
template<>
static inline const constexpr bool isOpaqueLayout<UMPCore::AdPosition> = true;
template<>
struct implClassFor<UMPCore::AdPosition> { using type = UMPCore::_impl::_impl_AdPosition; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class SWIFT_SYMBOL("s:7UMPCore7AdValueV") AdValue;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<UMPCore::AdValue> = true;
#pragma clang diagnostic pop
} // namespace swift
...
// Type metadata accessor for AdValue
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s7UMPCore7AdValueVMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:7UMPCore7AdValueV") AdValue final {
public:
  SWIFT_INLINE_THUNK ~AdValue() noexcept {
    auto metadata = _impl::$s7UMPCore7AdValueVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
#else
  ...
  SWIFT_INLINE_THUNK AdValue(const AdValue &other) noexcept {
    auto metadata = _impl::$s7UMPCore7AdValueVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK AdValue &operator =(const AdValue &other) noexcept {
    auto metadata = _impl::$s7UMPCore7AdValueVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK AdValue &operator =(AdValue &&other) = delete;
  [[noreturn]] SWIFT_INLINE_PRIVATE_HELPER AdValue(AdValue &&) noexcept {
  swift::_impl::_fatalError_Cxx_move_of_Swift_value_type_not_supported_yet();
  swift::_impl::_swift_stdlib_reportFatalError("swift", 5, "C++ does not support moving a Swift value yet", 45, 0);
  abort();
  }
  SWIFT_INLINE_THUNK swift::Int getValue() const SWIFT_SYMBOL("s:7UMPCore7AdValueV5valueSivp");
  SWIFT_INLINE_THUNK swift::String getCurrencyCode() const SWIFT_SYMBOL("s:7UMPCore7AdValueV12currencyCodeSSvp");
  static SWIFT_INLINE_THUNK AdValue init(swift::Int value, const swift::Optional<swift::String>& currencyCode) SWIFT_SYMBOL("s:7UMPCore7AdValueV5value12currencyCodeACSi_SSSgtcfc");
private:
  SWIFT_INLINE_THUNK AdValue(swift::_impl::ValueWitnessTable * _Nonnull vwTable) noexcept : _storage(vwTable->size, vwTable->getAlignment()) {}
  static SWIFT_INLINE_THUNK AdValue _make() noexcept {
    auto metadata = _impl::$s7UMPCore7AdValueVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
    ...
    auto *vwTable = *vwTableAddr;
#endif
    return AdValue(vwTable);
  }
  SWIFT_INLINE_THUNK const char * _Nonnull _getOpaquePointer() const noexcept { return _storage.getOpaquePointer(); }
  SWIFT_INLINE_THUNK char * _Nonnull _getOpaquePointer() noexcept { return _storage.getOpaquePointer(); }

  swift::_impl::OpaqueStorage _storage;
  friend class _impl::_impl_AdValue;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s7UMPCore7AdValueVD;
  static inline constexpr $s7UMPCore7AdValueVD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_AdValue {
public:
  static SWIFT_INLINE_THUNK char * _Nonnull getOpaquePointer(AdValue &object) { return object._getOpaquePointer(); }
  static SWIFT_INLINE_THUNK const char * _Nonnull getOpaquePointer(const AdValue &object) { return object._getOpaquePointer(); }
  template<class T>
  static SWIFT_INLINE_PRIVATE_HELPER AdValue returnNewValue(T callable) {
    auto result = AdValue::_make();
    callable(result._getOpaquePointer());
    return result;
  }
  static SWIFT_INLINE_THUNK void initializeWithTake(char * _Nonnull destStorage, char * _Nonnull srcStorage) {
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<UMPCore::AdValue> {
  static SWIFT_INLINE_THUNK void * _Nonnull getTypeMetadata() {
    return UMPCore::_impl::$s7UMPCore7AdValueVMa(0)._0;
  }
};
namespace _impl{
template<>
static inline const constexpr bool isValueType<UMPCore::AdValue> = true;
template<>
static inline const constexpr bool isOpaqueLayout<UMPCore::AdValue> = true;
template<>
struct implClassFor<UMPCore::AdValue> { using type = UMPCore::_impl::_impl_AdValue; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class SWIFT_SYMBOL("s:7UMPCore9CppBridgeC") CppBridge;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<UMPCore::CppBridge> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_CppBridge;
// Type metadata accessor for CppBridge
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s7UMPCore9CppBridgeCMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:7UMPCore9CppBridgeC") CppBridge : public swift::_impl::RefCountedClass {
public:
  using RefCountedClass::RefCountedClass;
  using RefCountedClass::operator=;
  static SWIFT_INLINE_THUNK void setPluginExtraParameter(const swift::String& groupId, const swift::String& key, int8_t const * _Nullable value) SWIFT_SYMBOL("s:7UMPCore9CppBridgeC23setPluginExtraParameter7groupId3key5valueySS_SSSPys4Int8VGSgtFZ");
  static SWIFT_INLINE_THUNK int8_t * _Nullable getPluginExtraParameter(const swift::String& groupId, const swift::String& key) SWIFT_SYMBOL("s:7UMPCore9CppBridgeC23getPluginExtraParameter7groupId3keySpys4Int8VGSgSS_SStFZ");
  static SWIFT_INLINE_THUNK void setExtraParameter(swift::Int handle, const swift::String& unitId, const swift::String& key, const swift::String& value) SWIFT_SYMBOL("s:7UMPCore9CppBridgeC17setExtraParameter6handle6unitId3key5valueySi_S3StFZ");
  static SWIFT_INLINE_THUNK void load(swift::Int handle, const swift::String& unitId) SWIFT_SYMBOL("s:7UMPCore9CppBridgeC4load6handle6unitIdySi_SStFZ");
  static SWIFT_INLINE_THUNK bool isReady(swift::Int handle, const swift::String& unitId) SWIFT_SYMBOL("s:7UMPCore9CppBridgeC7isReady6handle6unitIdSbSi_SStFZ");
  static SWIFT_INLINE_THUNK void show(swift::Int handle, const swift::String& unitId) SWIFT_SYMBOL("s:7UMPCore9CppBridgeC4show6handle6unitIdySi_SStFZ");
  static SWIFT_INLINE_THUNK void destroy(swift::Int handle, const swift::String& unitId) SWIFT_SYMBOL("s:7UMPCore9CppBridgeC7destroy6handle6unitIdySi_SStFZ");
  static SWIFT_INLINE_THUNK void load(swift::Int handle, const swift::String& unitId, swift::Int width, swift::Int height, swift::Int position) SWIFT_SYMBOL("s:7UMPCore9CppBridgeC4load6handle6unitId5width6height8positionySi_SSS3itFZ");
  static SWIFT_INLINE_THUNK void hide(swift::Int handle, const swift::String& unitId) SWIFT_SYMBOL("s:7UMPCore9CppBridgeC4hide6handle6unitIdySi_SStFZ");
  static SWIFT_INLINE_THUNK int8_t * _Nullable getCharPointer(const swift::Optional<swift::String>& optionalString) SWIFT_SYMBOL("s:7UMPCore9CppBridgeC14getCharPointer4fromSpys4Int8VGSgSSSg_tFZ");
protected:
  SWIFT_INLINE_THUNK CppBridge(void * _Nonnull ptr) noexcept : RefCountedClass(ptr) {}
private:
  friend class _impl::_impl_CppBridge;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s7UMPCore9CppBridgeCD;
  static inline constexpr $s7UMPCore9CppBridgeCD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_CppBridge {
public:
static SWIFT_INLINE_THUNK CppBridge makeRetained(void * _Nonnull ptr) noexcept { return CppBridge(ptr); }
};
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<UMPCore::CppBridge> {
  static SWIFT_INLINE_THUNK void * _Nonnull getTypeMetadata() {
    return UMPCore::_impl::$s7UMPCore9CppBridgeCMa(0)._0;
  }
};
namespace _impl{
template<>
struct implClassFor<UMPCore::CppBridge> { using type = UMPCore::_impl::_impl_CppBridge; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class SWIFT_SYMBOL("s:7UMPCore11ErrorClientV") ErrorClient;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<UMPCore::ErrorClient> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_ErrorClient;

// Type metadata accessor for ErrorClient
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s7UMPCore11ErrorClientVMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:7UMPCore11ErrorClientV") ErrorClient final {
public:
  SWIFT_INLINE_THUNK ~ErrorClient() noexcept {
    auto metadata = _impl::$s7UMPCore11ErrorClientVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
#else
  ...
  SWIFT_INLINE_THUNK ErrorClient(const ErrorClient &other) noexcept {
    auto metadata = _impl::$s7UMPCore11ErrorClientVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK ErrorClient &operator =(const ErrorClient &other) noexcept {
    auto metadata = _impl::$s7UMPCore11ErrorClientVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK ErrorClient &operator =(ErrorClient &&other) = delete;
  [[noreturn]] SWIFT_INLINE_PRIVATE_HELPER ErrorClient(ErrorClient &&) noexcept {
  swift::_impl::_fatalError_Cxx_move_of_Swift_value_type_not_supported_yet();
  swift::_impl::_swift_stdlib_reportFatalError("swift", 5, "C++ does not support moving a Swift value yet", 45, 0);
  abort();
  }
  SWIFT_INLINE_THUNK swift::Int getCode() const SWIFT_SYMBOL("s:7UMPCore11ErrorClientV4codeSivp");
  SWIFT_INLINE_THUNK swift::String getMessage() const SWIFT_SYMBOL("s:7UMPCore11ErrorClientV7messageSSvp");
  static SWIFT_INLINE_THUNK ErrorClient init(swift::Int code, const swift::String& message) SWIFT_SYMBOL("s:7UMPCore11ErrorClientV4code7messageACSi_SStcfc");
private:
  SWIFT_INLINE_THUNK ErrorClient(swift::_impl::ValueWitnessTable * _Nonnull vwTable) noexcept : _storage(vwTable->size, vwTable->getAlignment()) {}
  static SWIFT_INLINE_THUNK ErrorClient _make() noexcept {
    auto metadata = _impl::$s7UMPCore11ErrorClientVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
    ...
    auto *vwTable = *vwTableAddr;
#endif
    return ErrorClient(vwTable);
  }
  SWIFT_INLINE_THUNK const char * _Nonnull _getOpaquePointer() const noexcept { return _storage.getOpaquePointer(); }
  SWIFT_INLINE_THUNK char * _Nonnull _getOpaquePointer() noexcept { return _storage.getOpaquePointer(); }

  swift::_impl::OpaqueStorage _storage;
  friend class _impl::_impl_ErrorClient;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s7UMPCore11ErrorClientVD;
  static inline constexpr $s7UMPCore11ErrorClientVD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_ErrorClient {
public:
  static SWIFT_INLINE_THUNK char * _Nonnull getOpaquePointer(ErrorClient &object) { return object._getOpaquePointer(); }
  static SWIFT_INLINE_THUNK const char * _Nonnull getOpaquePointer(const ErrorClient &object) { return object._getOpaquePointer(); }
  template<class T>
  static SWIFT_INLINE_PRIVATE_HELPER ErrorClient returnNewValue(T callable) {
    auto result = ErrorClient::_make();
    callable(result._getOpaquePointer());
    return result;
  }
  static SWIFT_INLINE_THUNK void initializeWithTake(char * _Nonnull destStorage, char * _Nonnull srcStorage) {
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<UMPCore::ErrorClient> {
  static SWIFT_INLINE_THUNK void * _Nonnull getTypeMetadata() {
    return UMPCore::_impl::$s7UMPCore11ErrorClientVMa(0)._0;
  }
};
namespace _impl{
template<>
static inline const constexpr bool isValueType<UMPCore::ErrorClient> = true;
template<>
static inline const constexpr bool isOpaqueLayout<UMPCore::ErrorClient> = true;
template<>
struct implClassFor<UMPCore::ErrorClient> { using type = UMPCore::_impl::_impl_ErrorClient; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class SWIFT_SYMBOL("s:7UMPCore6LoggerC") Logger;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<UMPCore::Logger> = true;
#pragma clang diagnostic pop
} // namespace swift
...
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s7UMPCore6LoggerCMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:7UMPCore6LoggerC") Logger : public swift::_impl::RefCountedClass {
public:
  using RefCountedClass::RefCountedClass;
  using RefCountedClass::operator=;
  static SWIFT_INLINE_THUNK void d(const swift::String& message) SWIFT_SYMBOL("s:7UMPCore6LoggerC1d7messageySS_tFZ");
protected:
  SWIFT_INLINE_THUNK Logger(void * _Nonnull ptr) noexcept : RefCountedClass(ptr) {}
private:
  friend class _impl::_impl_Logger;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s7UMPCore6LoggerCD;
  static inline constexpr $s7UMPCore6LoggerCD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_Logger {
public:
static SWIFT_INLINE_THUNK Logger makeRetained(void * _Nonnull ptr) noexcept { return Logger(ptr); }
};
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<UMPCore::Logger> {
  static SWIFT_INLINE_THUNK void * _Nonnull getTypeMetadata() {
    return UMPCore::_impl::$s7UMPCore6LoggerCMa(0)._0;
  }
};
namespace _impl{
template<>
struct implClassFor<UMPCore::Logger> { using type = UMPCore::_impl::_impl_Logger; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class SWIFT_SYMBOL("s:7UMPCore11MediationAdC") MediationAd;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<UMPCore::MediationAd> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_MediationAd;
// Type metadata accessor for MediationAd
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s7UMPCore11MediationAdCMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:7UMPCore11MediationAdC") MediationAd : public swift::_impl::RefCountedClass {
public:
  using RefCountedClass::RefCountedClass;
  using RefCountedClass::operator=;
  static SWIFT_INLINE_THUNK MediationAd init() SWIFT_SYMBOL("s:7UMPCore11MediationAdCACycfc");
  SWIFT_INLINE_THUNK swift::String toJson() SWIFT_SYMBOL("s:7UMPCore11MediationAdC6toJsonSSyF");
protected:
  SWIFT_INLINE_THUNK MediationAd(void * _Nonnull ptr) noexcept : RefCountedClass(ptr) {}
private:
  friend class _impl::_impl_MediationAd;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s7UMPCore11MediationAdCD;
  static inline constexpr $s7UMPCore11MediationAdCD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_MediationAd {
public:
static SWIFT_INLINE_THUNK MediationAd makeRetained(void * _Nonnull ptr) noexcept { return MediationAd(ptr); }
};
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<UMPCore::MediationAd> {
  static SWIFT_INLINE_THUNK void * _Nonnull getTypeMetadata() {
    return UMPCore::_impl::$s7UMPCore11MediationAdCMa(0)._0;
  }
};
namespace _impl{
template<>
struct implClassFor<UMPCore::MediationAd> { using type = UMPCore::_impl::_impl_MediationAd; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class SWIFT_SYMBOL("s:7UMPCore8PlatformV") Platform;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<UMPCore::Platform> = true;
#pragma clang diagnostic pop
} // namespace swift
...
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s7UMPCore8PlatformVMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:7UMPCore8PlatformV") Platform final {
public:
  SWIFT_INLINE_THUNK ~Platform() noexcept {
    auto metadata = _impl::$s7UMPCore8PlatformVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
#else
  ...
  SWIFT_INLINE_THUNK swift::Int getId() const SWIFT_SYMBOL("s:7UMPCore8PlatformV2idSivp");
  SWIFT_INLINE_THUNK swift::String getName() const SWIFT_SYMBOL("s:7UMPCore8PlatformV4nameSSvp");
  SWIFT_INLINE_THUNK void setName(const swift::String& value) SWIFT_SYMBOL("s:7UMPCore8PlatformV4nameSSvp");
  static SWIFT_INLINE_THUNK Platform init(swift::Int id, const swift::String& name) SWIFT_SYMBOL("s:7UMPCore8PlatformV2id4nameACSi_SStcfc");
private:
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s7UMPCore8PlatformVD;
  static inline constexpr $s7UMPCore8PlatformVD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_Platform {
public:
  static SWIFT_INLINE_THUNK char * _Nonnull getOpaquePointer(Platform &object) { return object._getOpaquePointer(); }
  static SWIFT_INLINE_THUNK const char * _Nonnull getOpaquePointer(const Platform &object) { return object._getOpaquePointer(); }
  template<class T>
  static SWIFT_INLINE_PRIVATE_HELPER Platform returnNewValue(T callable) {
    auto result = Platform::_make();
    callable(result._getOpaquePointer());
    return result;
  }
  static SWIFT_INLINE_THUNK void initializeWithTake(char * _Nonnull destStorage, char * _Nonnull srcStorage) {
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<UMPCore::Platform> {
  static SWIFT_INLINE_THUNK void * _Nonnull getTypeMetadata() {
    return UMPCore::_impl::$s7UMPCore8PlatformVMa(0)._0;
  }
};
namespace _impl{
template<>
static inline const constexpr bool isValueType<UMPCore::Platform> = true;
template<>
static inline const constexpr bool isOpaqueLayout<UMPCore::Platform> = true;
template<>
struct implClassFor<UMPCore::Platform> { using type = UMPCore::_impl::_impl_Platform; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class SWIFT_SYMBOL("s:7UMPCore13PluginManagerC") PluginManager;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<UMPCore::PluginManager> = true;
#pragma clang diagnostic pop
} // namespace swift
...
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s7UMPCore13PluginManagerCMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:7UMPCore13PluginManagerC") PluginManager : public swift::_impl::RefCountedClass {
public:
  using RefCountedClass::RefCountedClass;
  using RefCountedClass::operator=;
  static SWIFT_INLINE_THUNK void setExtraParameter(const swift::String& groupId, const swift::String& key, const swift::Optional<swift::String>& value) SWIFT_SYMBOL("s:7UMPCore13PluginManagerC17setExtraParameter7groupId3key5valueySS_S2SSgtFZ");
  static SWIFT_INLINE_THUNK swift::Optional<swift::String> getExtraParameter(const swift::String& groupId, const swift::String& key) SWIFT_SYMBOL("s:7UMPCore13PluginManagerC17getExtraParameter7groupId3keySSSgSS_SStFZ");
protected:
  SWIFT_INLINE_THUNK PluginManager(void * _Nonnull ptr) noexcept : RefCountedClass(ptr) {}
private:
  friend class _impl::_impl_PluginManager;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s7UMPCore13PluginManagerCD;
  static inline constexpr $s7UMPCore13PluginManagerCD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_PluginManager {
public:
static SWIFT_INLINE_THUNK PluginManager makeRetained(void * _Nonnull ptr) noexcept { return PluginManager(ptr); }
};
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<UMPCore::PluginManager> {
  static SWIFT_INLINE_THUNK void * _Nonnull getTypeMetadata() {
    return UMPCore::_impl::$s7UMPCore13PluginManagerCMa(0)._0;
  }
};
namespace _impl{
template<>
struct implClassFor<UMPCore::PluginManager> { using type = UMPCore::_impl::_impl_PluginManager; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class SWIFT_SYMBOL("s:7UMPCore9RevenueAdC") RevenueAd;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<UMPCore::RevenueAd> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_RevenueAd;
// Type metadata accessor for RevenueAd
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s7UMPCore9RevenueAdCMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:7UMPCore9RevenueAdC") RevenueAd : public MediationAd {
public:
  using MediationAd::MediationAd;
  using MediationAd::operator=;
  SWIFT_INLINE_THUNK double getRevenue() SWIFT_SYMBOL("s:7UMPCore9RevenueAdC7revenueSdvp");
  static SWIFT_INLINE_THUNK RevenueAd init(double revenue) SWIFT_SYMBOL("s:7UMPCore9RevenueAdC7revenueACSd_tcfc");
  static SWIFT_INLINE_THUNK RevenueAd init() SWIFT_SYMBOL("s:7UMPCore9RevenueAdCACycfc");
protected:
  SWIFT_INLINE_THUNK RevenueAd(void * _Nonnull ptr) noexcept : MediationAd(ptr) {}
private:
  friend class _impl::_impl_RevenueAd;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s7UMPCore9RevenueAdCD;
  static inline constexpr $s7UMPCore9RevenueAdCD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_RevenueAd {
public:
static SWIFT_INLINE_THUNK RevenueAd makeRetained(void * _Nonnull ptr) noexcept { return RevenueAd(ptr); }
};
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<UMPCore::RevenueAd> {
  static SWIFT_INLINE_THUNK void * _Nonnull getTypeMetadata() {
    return UMPCore::_impl::$s7UMPCore9RevenueAdCMa(0)._0;
  }
};
namespace _impl{
template<>
struct implClassFor<UMPCore::RevenueAd> { using type = UMPCore::_impl::_impl_RevenueAd; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class SWIFT_SYMBOL("s:7UMPCore6RewardV") Reward;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<UMPCore::Reward> = true;
#pragma clang diagnostic pop
} // namespace swift
...
// Type metadata accessor for Reward
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s7UMPCore6RewardVMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:7UMPCore6RewardV") Reward final {
public:
  SWIFT_INLINE_THUNK ~Reward() noexcept {
    auto metadata = _impl::$s7UMPCore6RewardVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
#else
  ...
  SWIFT_INLINE_THUNK Reward(const Reward &other) noexcept {
    auto metadata = _impl::$s7UMPCore6RewardVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK Reward &operator =(const Reward &other) noexcept {
    auto metadata = _impl::$s7UMPCore6RewardVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK Reward &operator =(Reward &&other) = delete;
  [[noreturn]] SWIFT_INLINE_PRIVATE_HELPER Reward(Reward &&) noexcept {
  swift::_impl::_fatalError_Cxx_move_of_Swift_value_type_not_supported_yet();
  swift::_impl::_swift_stdlib_reportFatalError("swift", 5, "C++ does not support moving a Swift value yet", 45, 0);
  abort();
  }
  SWIFT_INLINE_THUNK double getMount() const SWIFT_SYMBOL("s:7UMPCore6RewardV5mountSdvp");
  SWIFT_INLINE_THUNK swift::Optional<swift::String> getType() const SWIFT_SYMBOL("s:7UMPCore6RewardV4typeSSSgvp");
  static SWIFT_INLINE_THUNK Reward init(double mount, const swift::Optional<swift::String>& type) SWIFT_SYMBOL("s:7UMPCore6RewardV5mount4typeACSd_SSSgtcfc");
private:
  SWIFT_INLINE_THUNK Reward(swift::_impl::ValueWitnessTable * _Nonnull vwTable) noexcept : _storage(vwTable->size, vwTable->getAlignment()) {}
  static SWIFT_INLINE_THUNK Reward _make() noexcept {
    auto metadata = _impl::$s7UMPCore6RewardVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
    ...
    auto *vwTable = *vwTableAddr;
#endif
    return Reward(vwTable);
  }
  SWIFT_INLINE_THUNK const char * _Nonnull _getOpaquePointer() const noexcept { return _storage.getOpaquePointer(); }
  SWIFT_INLINE_THUNK char * _Nonnull _getOpaquePointer() noexcept { return _storage.getOpaquePointer(); }

  swift::_impl::OpaqueStorage _storage;
  friend class _impl::_impl_Reward;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s7UMPCore6RewardVD;
  static inline constexpr $s7UMPCore6RewardVD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_Reward {
public:
  static SWIFT_INLINE_THUNK char * _Nonnull getOpaquePointer(Reward &object) { return object._getOpaquePointer(); }
  static SWIFT_INLINE_THUNK const char * _Nonnull getOpaquePointer(const Reward &object) { return object._getOpaquePointer(); }
  template<class T>
  static SWIFT_INLINE_PRIVATE_HELPER Reward returnNewValue(T callable) {
    auto result = Reward::_make();
    callable(result._getOpaquePointer());
    return result;
  }
  static SWIFT_INLINE_THUNK void initializeWithTake(char * _Nonnull destStorage, char * _Nonnull srcStorage) {
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<UMPCore::Reward> {
  static SWIFT_INLINE_THUNK void * _Nonnull getTypeMetadata() {
    return UMPCore::_impl::$s7UMPCore6RewardVMa(0)._0;
  }
};
namespace _impl{
template<>
static inline const constexpr bool isValueType<UMPCore::Reward> = true;
template<>
static inline const constexpr bool isOpaqueLayout<UMPCore::Reward> = true;
template<>
struct implClassFor<UMPCore::Reward> { using type = UMPCore::_impl::_impl_Reward; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class SWIFT_SYMBOL("s:7UMPCore12UnityHandlerC") UnityHandler;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<UMPCore::UnityHandler> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_UnityHandler;
// Type metadata accessor for UnityHandler
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s7UMPCore12UnityHandlerCMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:7UMPCore12UnityHandlerC") UnityHandler : public swift::_impl::RefCountedClass {
public:
  using RefCountedClass::RefCountedClass;
  using RefCountedClass::operator=;
  SWIFT_INLINE_THUNK AdFormat getAdFormat() SWIFT_SYMBOL("s:7UMPCore12UnityHandlerC8adFormatAA02AdE0Ovp");
  SWIFT_INLINE_THUNK Platform getPlatform() SWIFT_SYMBOL("s:7UMPCore12UnityHandlerC8platformAA8PlatformVvp");
  SWIFT_INLINE_THUNK void setExtraParameter(const swift::String& unitId, const swift::String& key, const swift::Optional<swift::String>& value) SWIFT_SYMBOL("s:7UMPCore12UnityHandlerC17setExtraParameter6unitId3key5valueySS_S2SSgtF");
  SWIFT_INLINE_THUNK void load(const swift::String& unitId, swift::Int width, swift::Int height, swift::Int position) SWIFT_SYMBOL("s:7UMPCore12UnityHandlerC4load6unitId5width6height8positionySS_S3itF");
  SWIFT_INLINE_THUNK void load(const swift::String& unitId) SWIFT_SYMBOL("s:7UMPCore12UnityHandlerC4load6unitIdySS_tF");
  SWIFT_INLINE_THUNK bool isReady(const swift::String& unitId) SWIFT_SYMBOL("s:7UMPCore12UnityHandlerC7isReady6unitIdSbSS_tF");
  SWIFT_INLINE_THUNK void show(const swift::String& unitId) SWIFT_SYMBOL("s:7UMPCore12UnityHandlerC4show6unitIdySS_tF");
  SWIFT_INLINE_THUNK void hide(const swift::String& unitId) SWIFT_SYMBOL("s:7UMPCore12UnityHandlerC4hide6unitIdySS_tF");
  SWIFT_INLINE_THUNK void destroy(const swift::String& unitId) SWIFT_SYMBOL("s:7UMPCore12UnityHandlerC7destroy6unitIdySS_tF");
  SWIFT_INLINE_THUNK void onAdFailedToLoad(const swift::String& unitId, const ErrorClient& errorClient) SWIFT_SYMBOL("s:7UMPCore12UnityHandlerC16onAdFailedToLoad6unitId11errorClientySS_AA05ErrorL0VtF");
  SWIFT_INLINE_THUNK void onAdFailedToShow(const swift::String& unitId, const ErrorClient& errorClient) SWIFT_SYMBOL("s:7UMPCore12UnityHandlerC16onAdFailedToShow6unitId11errorClientySS_AA05ErrorL0VtF");
  SWIFT_INLINE_THUNK void onAdImpression(const swift::String& unitId) SWIFT_SYMBOL("s:7UMPCore12UnityHandlerC14onAdImpression6unitIdySS_tF");
  SWIFT_INLINE_THUNK void onAdClicked(const swift::String& unitId) SWIFT_SYMBOL("s:7UMPCore12UnityHandlerC11onAdClicked6unitIdySS_tF");
  SWIFT_INLINE_THUNK void onAdClosed(const swift::String& unitId) SWIFT_SYMBOL("s:7UMPCore12UnityHandlerC10onAdClosed6unitIdySS_tF");
  SWIFT_INLINE_THUNK void onUserEarnedReward(const swift::String& unitId, const Reward& reward) SWIFT_SYMBOL("s:7UMPCore12UnityHandlerC18onUserEarnedReward6unitId6rewardySS_AA0G0VtF");
  SWIFT_INLINE_THUNK void onBannerDetailOpened(const swift::String& unitId) SWIFT_SYMBOL("s:7UMPCore12UnityHandlerC20onBannerDetailOpened6unitIdySS_tF");
  SWIFT_INLINE_THUNK void onBannerDetailClosed(const swift::String& unitId) SWIFT_SYMBOL("s:7UMPCore12UnityHandlerC20onBannerDetailClosed6unitIdySS_tF");
protected:
  SWIFT_INLINE_THUNK UnityHandler(void * _Nonnull ptr) noexcept : RefCountedClass(ptr) {}
private:
  friend class _impl::_impl_UnityHandler;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s7UMPCore12UnityHandlerCD;
  static inline constexpr $s7UMPCore12UnityHandlerCD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_UnityHandler {
public:
static SWIFT_INLINE_THUNK UnityHandler makeRetained(void * _Nonnull ptr) noexcept { return UnityHandler(ptr); }
};
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<UMPCore::UnityHandler> {
  static SWIFT_INLINE_THUNK void * _Nonnull getTypeMetadata() {
    return UMPCore::_impl::$s7UMPCore12UnityHandlerCMa(0)._0;
  }
};
namespace _impl{
template<>
struct implClassFor<UMPCore::UnityHandler> { using type = UMPCore::_impl::_impl_UnityHandler; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
namespace UMPCore SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("UMPCore") {
  ...
  SWIFT_INLINE_THUNK AdFormat AdFormat::_impl_banner::operator()() const {
    auto result = AdFormat::_make();
    result._destructiveInjectEnumTag(_impl::$s7UMPCore8AdFormatO6banneryA2CmFWC);
    return result;
  }
  SWIFT_INLINE_THUNK  bool AdFormat::isBanner() const {
    return *this == AdFormat::banner;
  }
  SWIFT_INLINE_THUNK AdFormat AdFormat::_impl_interstitial::operator()() const {
    auto result = AdFormat::_make();
    result._destructiveInjectEnumTag(_impl::$s7UMPCore8AdFormatO12interstitialyA2CmFWC);
    return result;
  }
  SWIFT_INLINE_THUNK  bool AdFormat::isInterstitial() const {
    return *this == AdFormat::interstitial;
  }
  SWIFT_INLINE_THUNK AdFormat AdFormat::_impl_reward::operator()() const {
    auto result = AdFormat::_make();
    result._destructiveInjectEnumTag(_impl::$s7UMPCore8AdFormatO6rewardyA2CmFWC);
    return result;
  }
  SWIFT_INLINE_THUNK  bool AdFormat::isReward() const {
    return *this == AdFormat::reward;
  }
  SWIFT_INLINE_THUNK  bool AdFormat::isUnknownDefault() const {
    return *this == AdFormat::unknownDefault;
  }
  SWIFT_INLINE_THUNK swift::String AdFormat::name() const {
  return swift::_impl::_impl_String::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::swift_interop_returnDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(result, _impl::$s7UMPCore8AdFormatO4nameSSyF(_getOpaquePointer()));
  });
  }
  SWIFT_INLINE_THUNK swift::Optional<AdFormat> AdFormat::init(swift::Int rawValue) {
  return swift::_impl::_impl_Optional<AdFormat>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::$s7UMPCore8AdFormatO8rawValueACSgSi_tcfC(result, rawValue);
  });
  }
  SWIFT_INLINE_THUNK swift::Int AdFormat::getRawValue() const {
  return _impl::$s7UMPCore8AdFormatO8rawValueSivg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK AdPosition AdPosition::_impl_top::operator()() const {
    auto result = AdPosition::_make();
    result._destructiveInjectEnumTag(_impl::$s7UMPCore10AdPositionO3topyA2CmFWC);
    return result;
  }
  SWIFT_INLINE_THUNK  bool AdPosition::isTop() const {
    return *this == AdPosition::top;
  }
  SWIFT_INLINE_THUNK AdPosition AdPosition::_impl_center::operator()() const {
    auto result = AdPosition::_make();
    result._destructiveInjectEnumTag(_impl::$s7UMPCore10AdPositionO6centeryA2CmFWC);
    return result;
  }
  SWIFT_INLINE_THUNK  bool AdPosition::isCenter() const {
    return *this == AdPosition::center;
  }
  SWIFT_INLINE_THUNK AdPosition AdPosition::_impl_bottom::operator()() const {
    auto result = AdPosition::_make();
    result._destructiveInjectEnumTag(_impl::$s7UMPCore10AdPositionO6bottomyA2CmFWC);
    return result;
  }
  SWIFT_INLINE_THUNK  bool AdPosition::isBottom() const {
    return *this == AdPosition::bottom;
  }
  SWIFT_INLINE_THUNK  bool AdPosition::isUnknownDefault() const {
    return *this == AdPosition::unknownDefault;
  }
  SWIFT_INLINE_THUNK swift::Optional<AdPosition> AdPosition::init(swift::Int rawValue) {
  return swift::_impl::_impl_Optional<AdPosition>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::$s7UMPCore10AdPositionO8rawValueACSgSi_tcfC(result, rawValue);
  });
  }
  SWIFT_INLINE_THUNK swift::Int AdPosition::getRawValue() const {
  return _impl::$s7UMPCore10AdPositionO8rawValueSivg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK swift::Int AdValue::getValue() const {
  return _impl::$s7UMPCore7AdValueV5valueSivg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK swift::String AdValue::getCurrencyCode() const {
  return swift::_impl::_impl_String::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::swift_interop_returnDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(result, _impl::$s7UMPCore7AdValueV12currencyCodeSSvg(_getOpaquePointer()));
  });
  }
  SWIFT_INLINE_THUNK AdValue AdValue::init(swift::Int value, const swift::Optional<swift::String>& currencyCode) {
  return _impl::_impl_AdValue::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::$s7UMPCore7AdValueV5value12currencyCodeACSi_SSSgtcfC(result, value, _impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_uint64_t_8_16(swift::_impl::_impl_Optional<swift::String>::getOpaquePointer(currencyCode)));
  });
  }
  SWIFT_INLINE_THUNK void CppBridge::setPluginExtraParameter(const swift::String& groupId, const swift::String& key, int8_t const * _Nullable value) {
  return _impl::$s7UMPCore9CppBridgeC23setPluginExtraParameter7groupId3key5valueySS_SSSPys4Int8VGSgtFZ(_impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(groupId)), _impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(key)), value, swift::TypeMetadataTrait<CppBridge>::getTypeMetadata());
  }
  SWIFT_INLINE_THUNK int8_t * _Nullable CppBridge::getPluginExtraParameter(const swift::String& groupId, const swift::String& key) {
  return _impl::$s7UMPCore9CppBridgeC23getPluginExtraParameter7groupId3keySpys4Int8VGSgSS_SStFZ(_impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(groupId)), _impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(key)), swift::TypeMetadataTrait<CppBridge>::getTypeMetadata());
  }
  SWIFT_INLINE_THUNK void CppBridge::setExtraParameter(swift::Int handle, const swift::String& unitId, const swift::String& key, const swift::String& value) {
  return _impl::$s7UMPCore9CppBridgeC17setExtraParameter6handle6unitId3key5valueySi_S3StFZ(handle, _impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(unitId)), _impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(key)), _impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(value)), swift::TypeMetadataTrait<CppBridge>::getTypeMetadata());
  }
  SWIFT_INLINE_THUNK void CppBridge::load(swift::Int handle, const swift::String& unitId) {
  return _impl::$s7UMPCore9CppBridgeC4load6handle6unitIdySi_SStFZ(handle, _impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(unitId)), swift::TypeMetadataTrait<CppBridge>::getTypeMetadata());
  }
  SWIFT_INLINE_THUNK bool CppBridge::isReady(swift::Int handle, const swift::String& unitId) {
  return _impl::$s7UMPCore9CppBridgeC7isReady6handle6unitIdSbSi_SStFZ(handle, _impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(unitId)), swift::TypeMetadataTrait<CppBridge>::getTypeMetadata());
  }
  SWIFT_INLINE_THUNK void CppBridge::show(swift::Int handle, const swift::String& unitId) {
  return _impl::$s7UMPCore9CppBridgeC4show6handle6unitIdySi_SStFZ(handle, _impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(unitId)), swift::TypeMetadataTrait<CppBridge>::getTypeMetadata());
  }
  SWIFT_INLINE_THUNK void CppBridge::destroy(swift::Int handle, const swift::String& unitId) {
  return _impl::$s7UMPCore9CppBridgeC7destroy6handle6unitIdySi_SStFZ(handle, _impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(unitId)), swift::TypeMetadataTrait<CppBridge>::getTypeMetadata());
  }
  SWIFT_INLINE_THUNK void CppBridge::load(swift::Int handle, const swift::String& unitId, swift::Int width, swift::Int height, swift::Int position) {
  return _impl::$s7UMPCore9CppBridgeC4load6handle6unitId5width6height8positionySi_SSS3itFZ(handle, _impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(unitId)), width, height, position, swift::TypeMetadataTrait<CppBridge>::getTypeMetadata());
  }
  SWIFT_INLINE_THUNK void CppBridge::hide(swift::Int handle, const swift::String& unitId) {
  return _impl::$s7UMPCore9CppBridgeC4hide6handle6unitIdySi_SStFZ(handle, _impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(unitId)), swift::TypeMetadataTrait<CppBridge>::getTypeMetadata());
  }
  SWIFT_INLINE_THUNK int8_t * _Nullable CppBridge::getCharPointer(const swift::Optional<swift::String>& optionalString) {
  return _impl::$s7UMPCore9CppBridgeC14getCharPointer4fromSpys4Int8VGSgSSSg_tFZ(_impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_uint64_t_8_16(swift::_impl::_impl_Optional<swift::String>::getOpaquePointer(optionalString)), swift::TypeMetadataTrait<CppBridge>::getTypeMetadata());
  }
  SWIFT_INLINE_THUNK swift::Int ErrorClient::getCode() const {
  return _impl::$s7UMPCore11ErrorClientV4codeSivg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK swift::String ErrorClient::getMessage() const {
  return swift::_impl::_impl_String::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::swift_interop_returnDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(result, _impl::$s7UMPCore11ErrorClientV7messageSSvg(_getOpaquePointer()));
  });
  }
  SWIFT_INLINE_THUNK ErrorClient ErrorClient::init(swift::Int code, const swift::String& message) {
  return _impl::_impl_ErrorClient::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::$s7UMPCore11ErrorClientV4code7messageACSi_SStcfC(result, code, _impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(message)));
  });
  }
  SWIFT_INLINE_THUNK void Logger::d(const swift::String& message) {
  return _impl::$s7UMPCore6LoggerC1d7messageySS_tFZ(_impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(message)), swift::TypeMetadataTrait<Logger>::getTypeMetadata());
  }
  SWIFT_INLINE_THUNK MediationAd MediationAd::init() {
  return _impl::_impl_MediationAd::makeRetained(_impl::$s7UMPCore11MediationAdCACycfC(swift::TypeMetadataTrait<MediationAd>::getTypeMetadata()));
  }
  SWIFT_INLINE_THUNK swift::String MediationAd::toJson() {
  return swift::_impl::_impl_String::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::swift_interop_returnDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(result, _impl::$s7UMPCore11MediationAdC6toJsonSSyFTj(::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this)));
  });
  }
  SWIFT_INLINE_THUNK swift::Int Platform::getId() const {
  return _impl::$s7UMPCore8PlatformV2idSivg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK swift::String Platform::getName() const {
  return swift::_impl::_impl_String::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::swift_interop_returnDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(result, _impl::$s7UMPCore8PlatformV4nameSSvg(_getOpaquePointer()));
  });
  }
  SWIFT_INLINE_THUNK void Platform::setName(const swift::String& value) {
  return _impl::$s7UMPCore8PlatformV4nameSSvs(_impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(value)), _getOpaquePointer());
  }
  SWIFT_INLINE_THUNK Platform Platform::init(swift::Int id, const swift::String& name) {
  return _impl::_impl_Platform::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::$s7UMPCore8PlatformV2id4nameACSi_SStcfC(result, id, _impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(name)));
  });
  }
  SWIFT_INLINE_THUNK void PluginManager::setExtraParameter(const swift::String& groupId, const swift::String& key, const swift::Optional<swift::String>& value) {
  return _impl::$s7UMPCore13PluginManagerC17setExtraParameter7groupId3key5valueySS_S2SSgtFZ(_impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(groupId)), _impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(key)), _impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_uint64_t_8_16(swift::_impl::_impl_Optional<swift::String>::getOpaquePointer(value)), swift::TypeMetadataTrait<PluginManager>::getTypeMetadata());
  }
  SWIFT_INLINE_THUNK swift::Optional<swift::String> PluginManager::getExtraParameter(const swift::String& groupId, const swift::String& key) {
  return swift::_impl::_impl_Optional<swift::String>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::swift_interop_returnDirect_UMPCore_uint64_t_0_8_uint64_t_8_16(result, _impl::$s7UMPCore13PluginManagerC17getExtraParameter7groupId3keySSSgSS_SStFZ(_impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(groupId)), _impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(key)), swift::TypeMetadataTrait<PluginManager>::getTypeMetadata()));
  });
  }
  SWIFT_INLINE_THUNK double RevenueAd::getRevenue() {
  return _impl::$s7UMPCore9RevenueAdC7revenueSdvg(::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK RevenueAd RevenueAd::init(double revenue) {
  return _impl::_impl_RevenueAd::makeRetained(_impl::$s7UMPCore9RevenueAdC7revenueACSd_tcfC(revenue, swift::TypeMetadataTrait<RevenueAd>::getTypeMetadata()));
  }
  SWIFT_INLINE_THUNK RevenueAd RevenueAd::init() {
  return _impl::_impl_RevenueAd::makeRetained(_impl::$s7UMPCore9RevenueAdCACycfC(swift::TypeMetadataTrait<RevenueAd>::getTypeMetadata()));
  }
  SWIFT_INLINE_THUNK double Reward::getMount() const {
  return _impl::$s7UMPCore6RewardV5mountSdvg(_getOpaquePointer());
  }
  SWIFT_INLINE_THUNK swift::Optional<swift::String> Reward::getType() const {
  return swift::_impl::_impl_Optional<swift::String>::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::swift_interop_returnDirect_UMPCore_uint64_t_0_8_uint64_t_8_16(result, _impl::$s7UMPCore6RewardV4typeSSSgvg(_getOpaquePointer()));
  });
  }
  SWIFT_INLINE_THUNK Reward Reward::init(double mount, const swift::Optional<swift::String>& type) {
  return _impl::_impl_Reward::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::$s7UMPCore6RewardV5mount4typeACSd_SSSgtcfC(result, mount, _impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_uint64_t_8_16(swift::_impl::_impl_Optional<swift::String>::getOpaquePointer(type)));
  });
  }
  SWIFT_INLINE_THUNK AdFormat UnityHandler::getAdFormat() {
  return _impl::_impl_AdFormat::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::$s7UMPCore12UnityHandlerC8adFormatAA02AdE0Ovg(result, ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  });
  }
  SWIFT_INLINE_THUNK Platform UnityHandler::getPlatform() {
  return _impl::_impl_Platform::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::$s7UMPCore12UnityHandlerC8platformAA8PlatformVvg(result, ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  });
  }
  SWIFT_INLINE_THUNK void UnityHandler::setExtraParameter(const swift::String& unitId, const swift::String& key, const swift::Optional<swift::String>& value) {
  return _impl::$s7UMPCore12UnityHandlerC17setExtraParameter6unitId3key5valueySS_S2SSgtFTj(_impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(unitId)), _impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(key)), _impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_uint64_t_8_16(swift::_impl::_impl_Optional<swift::String>::getOpaquePointer(value)), ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK void UnityHandler::load(const swift::String& unitId, swift::Int width, swift::Int height, swift::Int position) {
  return _impl::$s7UMPCore12UnityHandlerC4load6unitId5width6height8positionySS_S3itFTj(_impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(unitId)), width, height, position, ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK void UnityHandler::load(const swift::String& unitId) {
  return _impl::$s7UMPCore12UnityHandlerC4load6unitIdySS_tFTj(_impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(unitId)), ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK bool UnityHandler::isReady(const swift::String& unitId) {
  return _impl::$s7UMPCore12UnityHandlerC7isReady6unitIdSbSS_tFTj(_impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(unitId)), ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK void UnityHandler::show(const swift::String& unitId) {
  return _impl::$s7UMPCore12UnityHandlerC4show6unitIdySS_tFTj(_impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(unitId)), ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK void UnityHandler::hide(const swift::String& unitId) {
  return _impl::$s7UMPCore12UnityHandlerC4hide6unitIdySS_tFTj(_impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(unitId)), ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK void UnityHandler::destroy(const swift::String& unitId) {
  return _impl::$s7UMPCore12UnityHandlerC7destroy6unitIdySS_tFTj(_impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(unitId)), ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK void UnityHandler::onAdFailedToLoad(const swift::String& unitId, const ErrorClient& errorClient) {
  return _impl::$s7UMPCore12UnityHandlerC16onAdFailedToLoad6unitId11errorClientySS_AA05ErrorL0VtFTj(_impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(unitId)), _impl::_impl_ErrorClient::getOpaquePointer(errorClient), ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK void UnityHandler::onAdFailedToShow(const swift::String& unitId, const ErrorClient& errorClient) {
  return _impl::$s7UMPCore12UnityHandlerC16onAdFailedToShow6unitId11errorClientySS_AA05ErrorL0VtFTj(_impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(unitId)), _impl::_impl_ErrorClient::getOpaquePointer(errorClient), ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK void UnityHandler::onAdImpression(const swift::String& unitId) {
  return _impl::$s7UMPCore12UnityHandlerC14onAdImpression6unitIdySS_tFTj(_impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(unitId)), ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK void UnityHandler::onAdClicked(const swift::String& unitId) {
  return _impl::$s7UMPCore12UnityHandlerC11onAdClicked6unitIdySS_tFTj(_impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(unitId)), ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK void UnityHandler::onAdClosed(const swift::String& unitId) {
  return _impl::$s7UMPCore12UnityHandlerC10onAdClosed6unitIdySS_tFTj(_impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(unitId)), ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK void UnityHandler::onUserEarnedReward(const swift::String& unitId, const Reward& reward) {
  return _impl::$s7UMPCore12UnityHandlerC18onUserEarnedReward6unitId6rewardySS_AA0G0VtFTj(_impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(unitId)), _impl::_impl_Reward::getOpaquePointer(reward), ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK void UnityHandler::onBannerDetailOpened(const swift::String& unitId) {
  return _impl::$s7UMPCore12UnityHandlerC20onBannerDetailOpened6unitIdySS_tFTj(_impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(unitId)), ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK void UnityHandler::onBannerDetailClosed(const swift::String& unitId) {
  return _impl::$s7UMPCore12UnityHandlerC20onBannerDetailClosed6unitIdySS_tFTj(_impl::swift_interop_passDirect_UMPCore_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(unitId)), ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }

class IAdClient { } SWIFT_UNAVAILABLE_MSG("protocol 'IAdClient' can not yet be represented in C++");

class IBannerClient { } SWIFT_UNAVAILABLE_MSG("protocol 'IBannerClient' can not yet be represented in C++");

class IEncodableJson { } SWIFT_UNAVAILABLE_MSG("protocol 'IEncodableJson' can not yet be represented in C++");

class IFullScreenClient { } SWIFT_UNAVAILABLE_MSG("protocol 'IFullScreenClient' can not yet be represented in C++");

class IJson { } SWIFT_UNAVAILABLE_MSG("protocol 'IJson' can not yet be represented in C++");

class IMediationAd { } SWIFT_UNAVAILABLE_MSG("protocol 'IMediationAd' can not yet be represented in C++");

class IPlatformClient { } SWIFT_UNAVAILABLE_MSG("protocol 'IPlatformClient' can not yet be represented in C++");

class IRevenueAd { } SWIFT_UNAVAILABLE_MSG("protocol 'IRevenueAd' can not yet be represented in C++");

class IUnityAdClickListener { } SWIFT_UNAVAILABLE_MSG("protocol 'IUnityAdClickListener' can not yet be represented in C++");

class IUnityAdCloseListener { } SWIFT_UNAVAILABLE_MSG("protocol 'IUnityAdCloseListener' can not yet be represented in C++");

class IUnityAdFailedToShowListener { } SWIFT_UNAVAILABLE_MSG("protocol 'IUnityAdFailedToShowListener' can not yet be represented in C++");

class IUnityAdImpressionCallback { } SWIFT_UNAVAILABLE_MSG("protocol 'IUnityAdImpressionCallback' can not yet be represented in C++");

class IUnityAdLoadCallback { } SWIFT_UNAVAILABLE_MSG("protocol 'IUnityAdLoadCallback' can not yet be represented in C++");

class IUnityAdPaidListener { } SWIFT_UNAVAILABLE_MSG("protocol 'IUnityAdPaidListener' can not yet be represented in C++");

class IUnityBannerCallback { } SWIFT_UNAVAILABLE_MSG("protocol 'IUnityBannerCallback' can not yet be represented in C++");

class IUnityCallback { } SWIFT_UNAVAILABLE_MSG("protocol 'IUnityCallback' can not yet be represented in C++");

class IUnityFullscreenCallback { } SWIFT_UNAVAILABLE_MSG("protocol 'IUnityFullscreenCallback' can not yet be represented in C++");

class IUnityInterstitialCallback { } SWIFT_UNAVAILABLE_MSG("protocol 'IUnityInterstitialCallback' can not yet be represented in C++");

class IUnityRewardCallback { } SWIFT_UNAVAILABLE_MSG("protocol 'IUnityRewardCallback' can not yet be represented in C++");

// Unavailable in C++: Swift type alias 'SwiftCallback'.
